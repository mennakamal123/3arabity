            ...
            <table class="table table-dark table-bordered table-striped">
                ...
                <tr>
                   <td><?php echo $year["name"]; ?></td>
                    <td>
                        <a class="btn btn-primary" href="years-trash.php?id=<?php echo $year["id"]; ?>&action=restore">Restore</a>
                        <a class="btn btn-danger" href="years-trash.php?id=<?php echo $year["id"]; ?>&action=forever">Force Delete</a>
                    </td>
                </tr>
                <?php } ?>
            </table>
